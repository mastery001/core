...
public class CreateSqlHelper {
	...
	public String createSqlByXml() throws DocumentException {
		return createSqlByXml("entitys.xml");
	}

	public String createSqlByXml(String configLocation) throws DocumentException {
		return createSqlByXml(ToolKit.getResourceAsStream(configLocation));
	}

	@SuppressWarnings("unchecked")
	public String createSqlByXml(InputStream is) throws DocumentException {
