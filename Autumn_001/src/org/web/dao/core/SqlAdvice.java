...
import org.web.dao.core.support.ColumnMeta;
...
public interface SqlAdvice extends PrintAdvice {
	 ...
	 * @throws SQLException
	 */
	String buildUpdateSql(String sql , List<ColumnMeta> list , String[] primaryKeyNames , Map<String, Object> beanMap) throws SQLException;
